...
at specs/001-sales-customer-pbi/plan.md
<!-- SPECKIT END -->
...
### Skills Used:
- `.github/skills/tableau-visual-extraction/SKILL.md` — Parse TWB visual XML
- `.github/skills/report-visual-generation/SKILL.md` — Generate Power BI report.json
- `.github/skills/report-visual-generation/report-constitution-template.md` — Formatting rules
